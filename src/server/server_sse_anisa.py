...
mcp_anisa.mount(tool_faq, "zena")
mcp_anisa.mount(tool_services, "zena")
mcp_anisa.mount(tool_record_time, "zena")
mcp_anisa.mount(tool_product_search, "zena")
mcp_anisa.mount(tool_remember_master, "zena")
mcp_anisa.mount(tool_remember_product_id, "zena")
mcp_anisa.mount(tool_avaliable_time_for_master, "zena")


if __name__ == "__main__":
    mcp_anisa.run(transport="sse", port=MCP_PORT_ANISA, host="0.0.0.0")
