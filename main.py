...
from src.server.server_sse_valentina import  mcp_valentina
...
MCP_PORT_VALENTINA = int(os.getenv("MCP_PORT_VALENTINA"))  # 5020
...
async def main():
    await asyncio.gather(
        ...
        mcp_valentina.run_async(transport="sse", port=MCP_PORT_VALENTINA, host="0.0.0.0"),
    )
