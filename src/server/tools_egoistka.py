"""tenant_egoistka — сборка списка tools для tenant'а Sofia.
...
async def build_tools_egoistka(server_name: str, channel_ids: list[str]) -> list[Tool]:
    """Собирает список tools для tenant'а Egoistka.
